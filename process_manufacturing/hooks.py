...
fixtures = [{"dt":"Custom Script","filters":[["dt", "in", ("Work Order2",'Stock Entry')]]},{"dt":"Custom Field", "filters": [["parent", "in", ("Work Order2","Bill Of Material2","Work Order Item2","Process Item",'Stock Entry')]]},{"dt":"DocType","filters":[["module", "in", ("Process Manufacturing")]]}]

doc_events = {
 	"Stock Entry": {
        "on_submit": "process_manufacturing.process_manufacturing.doctype.work_order2.work_order2.manage_se_changes",
        "on_cancel": "process_manufacturing.process_manufacturing.doctype.work_order2.work_order2.manage_se_changes"
    }
}
# Includes in <head>
# ------------------
...
doctype_js={'Stock Entry':"process_manufacturing.process_manufacturing.doctype.work_order2.stock_entry.js"}
doctype_js = {"Work Order2" : "process_manufacturing.process_manufacturing.doctype.work_order2.work_order2.js"}
